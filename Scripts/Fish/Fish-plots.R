...
load(file = "Scripts/Fish/Workspace/50-splits-per-fcount_2025-03-28/spp-Notolabrus fucicola-inla-forecasts.RData")

#
# Calculate the ASE
#

datorig <- read.csv("Scripts/summary-data/fish-clean.csv") %>% 
  filter(species_name == "Notolabrus fucicola")
...
sampled_splits <- read.csv("Scripts/summary-data/inverts_sampled-splits_50.csv") #ok to use for fish!!
...
g1
#ggsave(g1, filename = paste0("Plots/Fish/P.wrasse/P.wrasse_mega-plot_enviro-10_50.png"))
...
g2 <- preds_plots %>%  
  ...
  labs(x = "Year", y = "Prediction", color = "No. of fished sites")
g2
#ggsave(g2, filename = paste0("Plots/Fish/P.wrasse/P.wrasse_mega-plot_enviro-10_2_50.png"))
...
g3
#ggsave(g3, filename = paste0("Plots/Fish/P.wrasse/P.wrasse_mega-plot_ASE_enviro-10_50.png"))
...
g4
#ggsave(g4, filename = paste0("Plots/Fish/P.wrasse/P.wrasse_mega-plot_MASE_enviro-10_50.png"), dpi=1000)
...
#ggsave(robust_se_plot, filename = paste0("Plots/Fish/P.wrasse/P.wrasse_Figure_6.png"), dpi=1000)
